        ...
        <div className="grid lg:grid-cols-2 items-center">
          ...
          <div>
            ...
            <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
              We are a premier bioanalytical and bioinformatics service provider dedicated to 
              transforming the landscape of biological research and healthcare. At SukshmaDarshini™, 
              we specialize in bridging the gap between complex biological systems and meaningful 
              scientific insights.
            </p>
