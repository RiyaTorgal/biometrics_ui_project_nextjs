        ...
        <DialogContent className="max-w-md max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              {step === "confirmation" && "Appointment confirmation instructions will be sent via email"}
            </DialogDescription>
          </DialogHeader>
          ...
          {step === "confirmation" && (
            <div className="space-y-6 pt-4 text-center">
              <MailCheck className="w-32 h-32 mx-auto text-primary" />
              <p className="text-sm text-muted-foreground leading-relaxed">
                Your session for{" "}
                ...
                <br /><br />
                Please follow the steps given in the email to confirm your consultation appointment.
